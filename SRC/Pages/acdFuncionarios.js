...
export default function adcFuncionarios({navigation}) {
    ...
    function addNewProduct() {
      const FuncionarioDoc = collection(database, "funcionarios");
      addDoc(FuncionarioDoc, {
        codigo: newID,
        nome: newName,
        setor: newSetor,
        image: image
      ...
      navigation.navigate("GerenteHome");
    }
      ...
      <SafeAreaView style={styles.contaner}>
        <View style={styles.form}>
          <View style={styles.title}>
            <Text style={styles.text}>Cadastrar Funcionario</Text>
          </View>
